...
DROP TABLE "signature_statuses" CASCADE;--> statement-breakpoint
...
ALTER TABLE "signature_status" ADD CONSTRAINT "signature_status_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;